...
integer, parameter :: mj0=1*2+1,j0=modulo((11-1)*2,N_loc)+1  !<--- - 590nm
integer, parameter :: mj1=28*2+2,j1=modulo((21-1)*2,N_loc)+1!<--- + 500nm
...
if(myrank==mwT)then
 ...
 write(str_d,*) int(floor(d_half*2*1.0D9)),'nm.dat'
